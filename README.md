# 📚 Repositório de Estudos: Dart & Flutter

Bem-vindo ao meu repositório de aprendizagem!
Este espaço está organizado por branches para separar os projetos desenvolvidos durante cursos estruturados das minhas experimentações pessoais.

## 🛠️ Organização do Projeto

Este repositório utiliza múltiplas branches para organizar diferentes fases do aprendizado:
